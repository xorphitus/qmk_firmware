...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, KC_UP,   _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______, \
 ...
 */
[_RAISE] = LAYOUT( \
  KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   _______, _______, _______, _______, _______, KC_DEL, \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, KC_RGUI, KC_RALT, KC_RCTL, KC_RSFT \
),

/* Adjust (Lower + Raise)
 * ,-----------------------------------------------------------------------------------.
 * |BriDn |BriUp |      |      |      |      |MscPrv|MscPly|MscNxt|SndOff|SndDn |SndUp |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
